        ...
        <div class="navbar-user">
          ...
          <div v-if="authStore.isLoggedIn" class="navbar-user-dropdown" :class="{ active: showUserMenu }">
            ...
            <div class="navbar-user-menu">
              <a href="/settings.html" class="navbar-user-menu-item" @click="showUserMenu = false">
                <svg width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2">
              ...
              <a v-if="authStore.isAdmin" href="/admin/users" class="navbar-user-menu-item" @click="showUserMenu = false">
                <svg width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2">
          ...
          <router-link v-else to="/login.html" class="btn btn-primary btn-sm">登录</router-link>
        </div>
      </div>
    </div>
