    ...
    <div class="skill-card p-8 relative overflow-hidden">
      ...
      <div class="flex gap-4 mb-6 flex-wrap items-center">
        ...
        <select
          ...
          class="bg-base-950 border border-base-800 rounded-lg px-4 py-2.5 font-mono text-white focus:border-neon-400 focus:outline-none focus:ring-1 focus:ring-neon-400 transition-colors min-w-[140px] appearance-none cursor-pointer"
