<template>
  <div id="app" class="min-h-screen flex flex-col bg-base-950 text-zinc-300">
    ...
    <footer
      v-if="showNavbar"
      class="shrink-0 border-t border-zinc-800/80 py-4"
    >
      <div class="container max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div
          class="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-2 text-[11px] font-mono text-zinc-500"
        >
