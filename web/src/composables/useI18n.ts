...
const zh: Record<string, string> = {
  'nav.language': '切换语言',
  "settings.profileHint": "用于展示你的身份和技能贡献。",
  "settings.changeAvatar": "更换头像",
  "settings.cliHint": "连接本地命令行工具。",
  "settings.security": "账户安全",
  "settings.securityHint": "管理账户的登录密码。",
  "publish.pageHeading": "发布技能",
  "publish.pageHint": "上传技能包、在线编写，或从 GitHub 导入。",
  "publish.sourceStep": "准备技能内容",
  "publish.confirmStep": "确认信息并发布",
  "publish.repositoryLabel": "仓库地址",
  "publish.repositoryHint": "支持公开仓库链接或 owner/repo，默认读取仓库的默认分支。",
  "publish.advancedOptions": "高级选项 · 分支与子目录",
  "publish.readRepository": "读取仓库",
  "publish.chooseFolder": "选择文件夹",
  "publish.clearSelection": "清除已选文件",
  "publish.reviewHint": "确认技能内容和可见范围后发布。",
  'index.clearSearch': '清除搜索',
  "profile.title": "贡献者主页",
  "profile.visit": "查看 {name} 的贡献主页",
  "profile.moreContributors": "查看其他 {count} 位贡献者",
  "profile.noContributors": "暂无版本贡献者",
  "profile.skills": "贡献的技能",
  "profile.versions": "发布的版本",
  "profile.downloads": "贡献技能的下载量",
  "profile.scope": "展示你有权限查看的贡献；下载量为这些技能的累计下载。",
  "profile.joined": "加入于 {date}",
  "profile.empty": "还没有可见的技能贡献",
  "profile.emptyHint": "发布新技能或为已有技能发布版本后，贡献会显示在这里。",
  "profile.notFound": "用户不存在",
  "profile.loadError": "暂时无法加载贡献主页",
  "profile.retry": "重试",
  "profile.back": "返回技能库",
  "profile.search": "搜索贡献的技能",
  "profile.myPage": "我的主页",
  "index.library": "技能库",
  "index.libraryHint": "发现实用技能，也让你的贡献被看见。",
  "index.skillColumn": "技能",
  "index.downloadColumn": "下载",
  "index.favoriteColumn": "收藏",
  "index.updatedColumn": "更新",
  "index.resultCount": "{count} 个技能",
  "index.searchLabel": "搜索技能名称或描述",
  // Navbar
  'nav.home': '首页',
  'nav.publish': '发布',
  'nav.settings': '账户设置',
  ...
  'skill.installTitle': '获取技能',
  'skill.agentMethod': 'AI Agent',
  'skill.downloadMethod': '下载 ZIP',
  'skill.downloadHint': '无需 Node.js 或命令行，下载后导入支持 Skill 的 AI 工具。',
  'skill.downloadStep1': '选择版本，点击下方按钮下载 ZIP。',
  'skill.downloadStep2': '工具支持 ZIP 导入时，直接选择该文件；否则解压，保留 SKILL.md 及全部附带文件。',
  'skill.downloadStep3': '按所用工具的说明导入技能文件夹或放入技能目录，再刷新或重启。仅上传 SKILL.md 可能缺少依赖文件。',
  'skill.publicDownloadHint': '公开技能可直接下载，无需登录。',
  'skill.privateDownloadHint': '私有技能需登录有访问权限的账号。浏览器登录状态不会自动共享给 AI 助手。',
  'skill.promptVersion': '指定版本',
  'skill.downloadLoginError': '登录可能已失效或当前账号无权限。请登录有权限的账号后重试；版本也可能已被删除。',
  'skill.downloadError': '下载失败，版本可能已删除、访问受限或网络不可用。请刷新页面后重试。',
  'skill.cliMethod': '命令行',
  'skill.agentHint': '复制给能访问文件的 AI 助手，无需预装 Node.js 或 skb。',
  'skill.cliHint': '适合已使用 Node.js 的用户；通过 skb 安装并管理更新。',
  'skill.copyPrompt': '复制安装 Prompt',
  'skill.copyCommands': '复制全部命令',
  'skill.agentPrompt': '请帮我安装这个 Skill 到当前项目适合你的技能目录。技能页面：',
  'skill.agentPromptEnd': '优先直接下载上述 ZIP，不要要求安装 Node.js 或 skb。先确认当前 AI 工具支持的技能目录和项目级/个人级安装范围；不确定时询问我。下载失败、需要登录或无法访问本地/内网站点时，让我在浏览器登录有权限的账号并下载，再提供本地 ZIP；不要索取密码、Cookie 或令牌，不要尝试绕过权限。检查 ZIP 内容并安全解压，保留 SKILL.md 及附带文件，拒绝越界路径；不要执行包内脚本或覆盖已有技能，发生冲突先询问。安装后报告实际路径、所选版本和该工具的启用方式。如果你不能访问本地文件，请给我手动导入步骤。',
  'skill.tabPreview': '效果预览',
  'skill.previewHint': '查看技能的实际产出与使用效果，点击图片可放大。',
  'skill.previewEmpty': '还没有效果截图。上传一张实际产出，让大家更直观地了解这个技能。',
  'skill.moreDescription': '展开介绍',
  'skill.lessDescription': '收起介绍',
  'skill.deleteHint': '删除后，所有版本和文件都将无法恢复。',
  'skill.currentVersion': '当前浏览版本',
  ...
  'skill.tabFiles': '文件',
  'skill.tabVersions': '版本历史',
  'skill.tabTeam': '成员与权限',
  'skill.tabAccess': '权限与 Webhook',
  'skill.contributors': '贡献者',
  'skill.screenshots': '截图',
  'skill.screenshotUpload': '上传截图',
  'skill.screenshotUploading': '上传中...',
  'skill.screenshotUploadSuccess': '截图已上传',
  'skill.screenshotUploadFailed': '截图上传失败',
  'skill.screenshotDeleteConfirm': '确定删除这张截图吗？',
  'skill.screenshotDeleteFailed': '删除截图失败',
  'skill.screenshotPreview': '查看截图',
  'skill.noFile': '暂无文件',
  'skill.fullscreen': '全屏',
  ...
  'settings.avatarLabel': '头像',
  'settings.avatarHint': '从预设头像中选择，保存后立即生效',
  'settings.avatarDefault': '默认首字母',
  ...
  'collectionAdmin.membersModal': '维护集合技能',
...
const en: Record<string, string> = {
  ...
  "settings.profileHint": "Your identity across skills and contributions.",
  "settings.changeAvatar": "Change avatar",
  "settings.cliHint": "Connect your local command-line tools.",
  "settings.security": "Account security",
  "settings.securityHint": "Manage your sign-in password.",
  "publish.pageHeading": "Publish a skill",
  "publish.pageHint": "Upload a skill, write it here, or import from GitHub.",
  "publish.sourceStep": "Prepare skill content",
  "publish.confirmStep": "Review and publish",
  "publish.repositoryLabel": "Repository URL",
  "publish.repositoryHint": "Use a public repository URL or owner/repo. The default branch is used unless specified.",
  "publish.advancedOptions": "Advanced · branch and subdirectory",
  "publish.readRepository": "Read repository",
  "publish.chooseFolder": "Choose folder",
  "publish.clearSelection": "Clear selected files",
  "publish.reviewHint": "Review the skill content and visibility before publishing.",
  'index.clearSearch': 'Clear search',
  "profile.title": "Contributor profile",
  "profile.visit": "View {name}’s contributions",
  "profile.moreContributors": "View {count} more contributors",
  "profile.noContributors": "No version contributors yet",
  "profile.skills": "Skills contributed",
  "profile.versions": "Versions published",
  "profile.downloads": "Downloads of contributed skills",
  "profile.scope": "Only contributions you can access are shown. Downloads are totals for these skills.",
  "profile.joined": "Joined {date}",
  "profile.empty": "No visible contributions yet",
  "profile.emptyHint": "Publish a skill or a new version to see contributions here.",
  "profile.notFound": "User not found",
  "profile.loadError": "Unable to load this profile",
  "profile.retry": "Try again",
  "profile.back": "Back to skills",
  "profile.search": "Search contributed skills",
  "profile.myPage": "My profile",
  "index.library": "Skill library",
  "index.libraryHint": "Discover useful skills. Make your contributions count.",
  "index.skillColumn": "Skill",
  "index.downloadColumn": "Downloads",
  "index.favoriteColumn": "Favorites",
  "index.updatedColumn": "Updated",
  "index.resultCount": "{count} skills",
  "index.searchLabel": "Search skills by name or description",
  // Navbar
  'nav.home': 'Home',
  'nav.publish': 'Publish',
  ...
  'skill.installTitle': 'Get this skill',
  'skill.agentMethod': 'AI Agent',
  'skill.downloadMethod': 'Download ZIP',
  'skill.downloadHint': 'No Node.js or terminal required. Import the download into an AI tool that supports skills.',
  'skill.downloadStep1': 'Select a version and download the ZIP below.',
  'skill.downloadStep2': 'If your tool supports ZIP import, select the archive. Otherwise extract it, keeping SKILL.md and all companion files.',
  'skill.downloadStep3': 'Import the skill folder or place it in the directory documented by your tool, then reload or restart. Uploading only SKILL.md may omit required files.',
  'skill.publicDownloadHint': 'Public skill: download without signing in.',
  'skill.privateDownloadHint': 'Private skill: sign in with an authorized account. Your browser session is not automatically shared with an AI assistant.',
  'skill.promptVersion': 'Selected version',
  'skill.downloadLoginError': 'Your session may have expired or access is unavailable. Sign in with an authorized account and retry; the version may also have been removed.',
  'skill.downloadError': 'Download failed. The version may be missing, access restricted, or the network unavailable. Refresh and retry.',
  'skill.cliMethod': 'Command line',
  'skill.agentHint': 'Copy to an AI assistant with file access. No Node.js or skb required.',
  'skill.cliHint': 'For Node.js users: install and manage updates with skb.',
  'skill.copyPrompt': 'Copy installation prompt',
  'skill.copyCommands': 'Copy all commands',
  'skill.agentPrompt': 'Install this skill in the appropriate skill directory for the current project. Skill page:',
  'skill.agentPromptEnd': 'Download the ZIP directly; do not require Node.js or skb. Confirm the supported skill directory and project or personal scope for this AI tool; ask if unclear. If download fails, authentication is required, or this local/intranet site is unreachable, ask me to sign in with an authorized account in my browser, download the ZIP, and provide the local file. Never request passwords, cookies, or tokens or bypass access controls. Inspect and safely extract the archive, preserving SKILL.md and companion files; reject path traversal. Do not execute bundled scripts or overwrite existing skills without asking. Report the installed path, selected version, and activation steps. If you cannot access local files, provide manual import instructions.',
  'skill.tabPreview': 'Preview',
  'skill.previewHint': 'Explore skill outputs and examples. Select an image to enlarge it.',
  'skill.previewEmpty': 'No screenshots yet. Upload an example output to show what this skill can do.',
  'skill.moreDescription': 'Show more',
  'skill.lessDescription': 'Show less',
  'skill.deleteHint': 'All versions and files will be permanently removed.',
  'skill.currentVersion': 'Browsing version',
  ...
  'skill.tabFiles': 'Files',
  'skill.tabVersions': 'Versions',
  'skill.tabTeam': 'Team & Access',
  'skill.tabAccess': 'Access & Webhook',
  'skill.contributors': 'Contributors',
  'skill.screenshots': 'Screenshots',
  'skill.screenshotUpload': 'Upload screenshot',
  'skill.screenshotUploading': 'Uploading...',
  'skill.screenshotUploadSuccess': 'Screenshot uploaded',
  'skill.screenshotUploadFailed': 'Failed to upload screenshot',
  'skill.screenshotDeleteConfirm': 'Delete this screenshot?',
  'skill.screenshotDeleteFailed': 'Failed to delete screenshot',
  'skill.screenshotPreview': 'Preview screenshot',
  ...
  'settings.avatarHint': 'Pick a preset avatar, then save',
  'settings.avatarDefault': 'Initials',
  ...
  'collectionAdmin.membersModal': 'Edit collection skills',
